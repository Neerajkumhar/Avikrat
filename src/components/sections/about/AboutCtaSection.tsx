    ...
    <section aria-labelledby="about-cta-title" className="container-content py-28 md:py-40">
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at 50% 0%, rgba(34,211,197,0.09), transparent 55%)",
          }}
        />
        <motion.h2
          id="about-cta-title"
        ...
        >
          ...
          <br />
          of <span className="text-cyan">AI infrastructure.</span>
        </motion.h2>
        <motion.p variants={fadeUp} className="mx-auto mt-5 max-w-2xl text-base leading-relaxed text-soft">
          Interested in benchmarking, piloting, collaborating or learning more
          about AVIKRAT?
        </motion.p>
